...
\textbf{Actual Result:  } & The average result of 22 survey responses was 7.7 which is higher than \acceptableRating. Graph can be \href{run:NFR1.PNG}{found here.} \\
\textbf{Result: } & \textcolor{green}{PASS}\\
\hline
\end{tabularx}
\end{table}
...
\textbf{Actual Result: } &  The average result of 22 survey response was 7.6 which is higher than \acceptableRating. Graph can be \href{run:NFR2.PNG}{found here.} \\
\textbf{Result: } & \textcolor{green}{PASS}\\
\hline
...
\textbf{Output: } & Average results of survey \\
\textbf{Actual Result:  } &  The average result of 22 survey response was 7.6 which is higher than \acceptableRating. Graph can be \href{run:NFR4.PNG}{found here} \\
\textbf{Result: } & \textcolor{green}{PASS}\\
\hline
\end{tabularx}
\end{table}
...
\textbf{Actual Result:  } & The Web page was loaded \\
\textbf{Result: } & \textcolor{green}{PASS}\\
\hline
\end{tabularx}
\end{table}
...
\textbf{Input: } & N/A\\
\textbf{Output: } & The web page is loaded on the device from local WiFi \\
\textbf{Actual Result:  } & Web page was loaded \\
\textbf{Result: } & \textcolor{green}{PASS}\\
\hline
\end{tabularx}
\end{table}
...
\begin{tabularx}{\textwidth}{| c X |}
\hline
\multicolumn{2}{|c|}{\textbf{Web page is only accessible from a local network}}\\
\hline
\textbf{Type: } & Structural, Manual, Static\\
\textbf{Initial State: } & Attempt to load web page from outside the local network\\
\textbf{Input: } & N/A\\
\textbf{Output: } & HTML response \\
\textbf{Actual Result:  } & Server inaccessible \\
\textbf{Result: } & \textcolor{green}{PASS}\\
\hline
\end{tabularx}
\end{table}
...
\textbf{Input: } & N/A\\
\textbf{Output: } & HTML Response \\
\textbf{Actual Result:  } & Only user data was contained \\
\textbf{Result: } & \textcolor{green}{PASS}\\
\hline
\end{tabularx}
\end{table}
...
\item [\refstepcounter{mnum} \mthemnum \label{mAS}:] Flags
